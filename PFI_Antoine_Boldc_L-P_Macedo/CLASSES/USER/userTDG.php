...
class UserTDG extends DBAO{
    ...
    public function get_by_id($id){
        ...
        try{
            $conn = $this->connect();
            $tableName = $this->tableName;
            $query = "SELECT id, email, username, urls FROM $tableName WHERE id=:id";
            $stmt = $conn->prepare($query);
    ...
    public function get_all_users(){
        ...
        try{
            $conn = $this->connect();
            $tableName = $this->tableName;
            $query = "SELECT id, email, username, urls FROM $tableName";
            $stmt = $conn->prepare($query);
            $stmt->execute();
            $stmt->setFetchMode(PDO::FETCH_ASSOC);
            $result = $stmt->fetchAll();
    ...
    */
    public function update_info($email, $username, $id,$url){

        try{
            $conn = $this->connect();
            $tableName = $this->tableName;
            $query = "UPDATE $tableName SET email=:email, username=:username, urls=:urls WHERE id=:id";
            $stmt = $conn->prepare($query);
            $stmt->bindParam(':email', $email);
            $stmt->bindParam(':username', $username);
            $stmt->bindParam(':id', $id);
    ...
    */
    ...
    public function search_user_title_like($username){
        try{
            $conn = $this->connect();
            $tableName = $this->tableName;
